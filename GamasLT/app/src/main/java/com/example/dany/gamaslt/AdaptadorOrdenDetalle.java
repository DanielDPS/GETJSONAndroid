...
/**
 * Created by Juan on 26/4/2016.
 */
public class AdaptadorOrdenDetalle extends ArrayAdapter<Orden> {
    ...
    public  AdaptadorOrdenDetalle(Context context, ArrayList<Orden> ordenes){
